    ...
    <div class="content">
      ...
      <div class="content-box">
        <div class="message-box">
          ...
          <div class="select-box" v-if="enterEventRegisterPageMessage['patrolItemName'] != '' || moreEventMessage['eventType'] == 1">
            <div class="select-box-left">
              <span>巡更任务编号</span>
            </div>
            <div class="select-box-right">
          ...
          <div class="select-box" v-if="enterEventRegisterPageMessage['patrolItemName'] != '' || (moreEventMessage['eventType'] == 1 && moreEventMessage.itemName)">
            <div class="select-box-left">
              <span>巡查项</span>
            </div>
            <div class="select-box-right">
